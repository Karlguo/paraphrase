...
from set2seq.sequence_to_sequence import SequenceToSequence, EmbeddingsSharingLevel
from set2seq.encoders.encoder import ParallelEncoder
from set2seq.encoders.self_attention_encoder import SelfAttentionEncoder
from set2seq.decoders.self_attention_decoder import SelfAttentionDecoder
