...
from translater_zh2en import decoding_infer
from translater_zh2en import decoding
from translater_zh2en import constants
from translater_zh2en.config import load_model
...
def make_model_fn(trans_model,
  ...
  def _fn(features, labels, params, mode, config):
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      low_rate = 0.05
      ids_ori = tf.contrib.seq2seq.tile_batch(features["ids_ori"], beam_size)
